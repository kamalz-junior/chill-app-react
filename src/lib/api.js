...
//   const response = await fetch(
//     `${baseUrl}/discover/tv?page=2&api_key=${apiKey}`,
//   );
...
//   const response = await fetch(
//     `${baseUrl}/tv/airing_today?page=1&api_key=${apiKey}`,
//   );
...
//     `${baseUrl}/account/${accountId}/watchlist/movies?page=1&api_key=${apiKey}`,
//     {
//       headers: { Authorization: `Bearer ${token}` },
//     },
//   );
//   const responseTv = await fetch(
//     `${baseUrl}/account/${accountId}/watchlist/tv?page=1&api_key=${apiKey}`,
//     {
//       headers: { Authorization: `Bearer ${token}` },
//     },
//   );
